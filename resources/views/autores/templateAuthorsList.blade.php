...
@section('content')
    @if(Auth::check())
        @if(Auth::user()->tipo_utilizador=="admin")
            ...
            <div id="ControllerAdmin" class="container p-0 mt-0 tabulator"></div>
        @endif
    @endif

    @if(Auth::check() and Auth::user()->tipo_utilizador!="admin" or Auth::guest() )
                                                    ...
                                                    <div class="row">
                                                        <div class="col my-1">
                                                            <div class="d-flex justify-content-between">
                                                                <div>
                                                                    @if(Auth::check())
                                                                        @if(Auth::user()->tipo_utilizador=="admin" or Auth::user()->id ==$autor->id)
