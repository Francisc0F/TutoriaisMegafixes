        ...
        <div class="row">
            <div class="col-sm-3"><!--left col-->
                ...
                <div class="text-center" >
                    <img  class="photo mb-3" src="/storage/Fotos_utilizadores/{{Auth::user()->img_profile_utilizador}}" alt="avatar">
                    <div class="row">
                        <div class="col">
            ...
            <div class="col-sm-9">
                ...
                <div>
                    <div class="tab-pane active" id="home">
                        ...
                        <form class="form" action="utilizador/update/{{Auth::user()->id}}" method="post" id="registrationForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" value="{{Auth::user()->name}}" name="first_name" id="first_name" placeholder="first name" title="enter your first name if any.">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input type="email" class="form-control" value="{{Auth::user()->email}}" name="email" id="email" placeholder="you@email.com" title="enter your email.">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input type="pais" class="form-control" value="{{Auth::user()->pais_utilizador}}" name="pais" id="pais" placeholder="pais" >
                                </div>
                            </div><div class="form-group">

                                <div class="col-xs-6">
                                    <label for="cidade"><h4>Cidade</h4></label>
                                    <input type="cidade" class="form-control" value="{{Auth::user()->cidade_utilizador}}" name="cidade" id="cidade" placeholder="cidade" >
                                </div>
                            </div>
